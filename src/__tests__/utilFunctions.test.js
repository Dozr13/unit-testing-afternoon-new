...
test('shortenText should cut off extra characters at 100+ and add three periods to the end', () => {
...
test('attachUserName should remove posts that dont have a matching user', () => {
  const newPosts = attachUserName(users, posts)
